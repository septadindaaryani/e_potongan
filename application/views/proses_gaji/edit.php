          ...
          <form method="post" action="<?= base_url('Golongan/update'); ?>">
            <?php foreach ($datagolongan as $datagolongan) { ?>
              <div class="row">
                ...
                <div class="col-md-6">
                  <b>Nominal Golongan </b>
                  <input type="number" name="nominal_golongan" value="<?= $datagolongan->nominal_golongan ?>" class="form-control" placeholder="Nominal Golongan"></input>
                  <?= form_error('nominal_golongan', ' <small class="text-danger">', '</small>'); ?>
                </div>
              </div>
              <br>
